...
export class NewSearches extends Component {
  ...
  async handleSubmit(e) {
    ...
    try {
      await this.props.context.addSearch([
        new Search({
          value,
      ...
      <div className="box-material new-search-box">
        <form onSubmit={this.handleSubmit} className="form-search-add">
          <div className="flex-me">
            ...
            <Button blue className="mgi--left-7" type="submit">
              Add
            </Button>
            <Button
              blue
              className="mgi--left-7"
              onClick={() => this.testSearch(this.state['search-value-add'])}
              disabled={this.state['search-value-add'].trim() === ''}
            >
              Test
            </Button>
          </div>
          <div className="mgi--top-10 flex-me flex-align">
            ...
            />
            <label
              className="yt-uix-button yt-uix-button-size-default yt-uix-button-primary flex-me flex-align mgi--left-7"
